...
describe('application tests', () => {
  ...
  it('should render name: Nathan Gopee', () => {
    const element = screen.getByTestId('name');

    checkContent(element, /^Nathan Gopee$/, undefined, true);
  });
  ...
  it('should render creator', () => {
    ...
    checkContent(element, /^Nathan Gopee$/, 'https://www.gopee.dev/');
  });
  ...
  it('should render GitHub button', () => {
    ...
    checkButton(parent, child, /^GitHub$/, 'https://github.com/ndg8743/');
  });
  ...
  it('should render full footer on desktop', () => {
    ...
    expect(footer).toHaveTextContent(
      /^Designed and built by Nathan Gopee \| Source$/,
    );
  });
});
...
describe('app context tests', () => {
  it('should render partial footer on mobile', async () => {
    ...
    expect(footer).toHaveTextContent(/^Designed and built by Nathan Gopee$/);
  });
